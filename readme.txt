...
All functionality for milestone #3 is present, but the code could use better documentation.
Their are some HTML warnings on account-settings.html and user-profile-editor from how I (Darren) am using the <abbr> element, to get it to work on mobile.